...
if ( TRACE ) { TRACE( "BoardController#Initialize", this ); }
                ...
                if (UnityEngine.Component.op_Equality(this._grid, null)) {
                    UnityEngine.Debug.LogError$2("BoardController has no Grid reference.");
                    return;
                }
                ...
                try {
                    while ($t.moveNext()) {
                        var cell = $t.Current;
                        var gridPosition = this._grid.reportMethod( 'UnityEngine.GridLayout.WorldToCell', null );
...
if ( TRACE ) { TRACE( "BoardController#BuildNeighborCache", this ); }
                ...
                try {
                    while ($t.moveNext()) {
                        ...
                        var neighborDistance = this.GetGridNeighborDistance(cell.GridPosition);
                        ...
                        try {
                            while ($t1.moveNext()) {
                                ...
                                var distance = pc.Vec3.distance( this._grid.reportMethod( 'UnityEngine.Grid.GetCellCenterWorld', null ), this._grid.reportMethod( 'UnityEngine.Grid.GetCellCenterWorld', null ) );
            ...
            GetGridNeighborDistance: function (gridPosition) {
...
if ( TRACE ) { TRACE( "DragController#GetWorldPoint", this ); }
    ...
    Bridge.define("GameController", {
        ...
        statics: {
            methods: {
                /*GameController.FindSceneObjectIncludingInactive:static start.*/
                FindSceneObjectIncludingInactive: function (T) {
if ( TRACE ) { TRACE( "GameController#FindSceneObjectIncludingInactive", this ); }
                    ...
                    try {
                        while ($t.moveNext()) {
                            var target = Bridge.rValue($t.Current);
                            if (Bridge.rValue(target).gameObject.scene.isValid()) {
                                return Bridge.rValue(target);
                            }
                        }
                    } finally {
                        if (Bridge.is($t, System.IDisposable)) {
                ...
                /*GameController.FindSceneObjectIncludingInactive:static end.*/

                /*GameController.FindSceneObjectsIncludingInactive:static start.*/
                FindSceneObjectsIncludingInactive: function (T) {
if ( TRACE ) { TRACE( "GameController#FindSceneObjectsIncludingInactive", this ); }

                    var $t;
                    var objects = UnityEngine.Resources.FindObjectsOfTypeAll(T);
                    var sceneObjects = new (System.Collections.Generic.List$1(T)).$ctor2(objects.length);
                    $t = Bridge.getEnumerator(objects);
                    try {
                        while ($t.moveNext()) {
                            var target = Bridge.rValue($t.Current);
                            if (Bridge.rValue(target).gameObject.scene.isValid()) {
                                sceneObjects.add(Bridge.rValue(target));
                            }
                        }
                    } finally {
                        if (Bridge.is($t, System.IDisposable)) {
                ...
                /*GameController.FindSceneObjectsIncludingInactive:static end.*/
...
if ( TRACE ) { TRACE( "GameController#RunTurn", this ); }
            ...
            /*GameController.ResolveSceneReferences start.*/
            ResolveSceneReferences: function () {
if ( TRACE ) { TRACE( "GameController#ResolveSceneReferences", this ); }

                if (UnityEngine.Component.op_Equality(this._gameCamera, null)) {
                    this._gameCamera = UnityEngine.Camera.main;
                }

                if (UnityEngine.MonoBehaviour.op_Equality(this._board, null)) {
                    this._board = UnityEngine.Object.FindObjectOfType(BoardController);
                }

                if (UnityEngine.MonoBehaviour.op_Equality(this._dragController, null)) {
                    this._dragController = this.GetComponent(DragController);
                }

                if (UnityEngine.MonoBehaviour.op_Equality(this._reactionResolver, null)) {
                    this._reactionResolver = this.GetComponent(ReactionResolver);
                }

                if (UnityEngine.MonoBehaviour.op_Equality(this._tutorial, null)) {
                    this._tutorial = this.GetComponent(TutorialController);
                }

                if (UnityEngine.MonoBehaviour.op_Equality(this._packshot, null)) {
                    this._packshot = GameController.FindSceneObjectIncludingInactive(PackshotController);
                }
            },
            /*GameController.ResolveSceneReferences end.*/
...
if ( TRACE ) { TRACE( "GameController#InitializeStacks", this ); }
                ...
                var $t;
                var stacks = GameController.FindSceneObjectsIncludingInactive(HexStack);
...
if ( TRACE ) { TRACE( "HexCell#SetHighlight", this ); }
                ...
                if (UnityEngine.Component.op_Equality(this._ringRenderer, null)) {
                    return;
                }

                this._ringRenderer.enabled = true;
                if (!UnityEngine.Application.isPlaying) {
                    return;
                }

                if (this._ringRenderer.material.HasProperty$1("_Color")) {
                    this._ringRenderer.material.color = enabled ? new pc.Color( 0.42, 0.64, 0.95, 1.0 ) : new pc.Color( 0.18, 0.2, 0.23, 1.0 );
                }
            },
...
if ( TRACE ) { TRACE( "HexStack#CreateDisk", this ); }
                ...
                diskTransform.localScale = new pc.Vec3( 1, 1, 1 );
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                ...
                                case 3: {
                                    $enumerator.current = this.VanishStack(cell, stack);
                                        $step = 4;
                                        return true;
                                }
                                case 4: {
...
if ( TRACE ) { TRACE( "ReactionResolver#AnimateRollingDisk", this ); }
                ...
                DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Sequence, roll, function () {
                    if (UnityEngine.MonoBehaviour.op_Inequality(disk, null)) {
                        ...
                        DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Tweener, DG.Tweening.ShortcutExtensions.DOPunchScale(disk.transform, new pc.Vec3( 1, 1, 1 ).clone().scale( 0.08 ), 0.08, 1, 0.4), function () {
                            disk.transform.localScale = new pc.Vec3( 1, 1, 1 );
            ...
            VanishStack: function (cell, stack) {
                ...
                var $enumerator = new Bridge.GeneratorEnumerator(Bridge.fn.bind(this, function () {
                    try {
                        for (;;) {
                            switch ($step) {
                                case 0: {
                                    disks = stack.RemoveTopDisks(this._vanishStackSize);
                                        if (UnityEngine.GameObject.op_Inequality(this._vanishFxPrefab, null)) {
                                            fx = UnityEngine.Object.Instantiate$2(UnityEngine.GameObject, this._vanishFxPrefab, stack.transform.position.$clone().add( pc.Vec3.UP.clone().clone().scale( 0.35 ) ), pc.Quat.IDENTITY.clone());
                                            fx.SetActive(true);
                                            particles = fx.GetComponent(UnityEngine.ParticleSystem);
                                        ...
                                        duration = this.GetScaledDuration(this._baseVanishDuration);
                                        vanish = DG.Tweening.DOTween.Sequence();
                                        $t = Bridge.getEnumerator(disks);
                                        try {
                                            while ($t.moveNext()) {
                                                disk = $t.Current;
                                                DG.Tweening.TweenSettingsExtensions.Join(vanish, DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOScale$1(disk.transform, pc.Vec3.ZERO.clone(), duration), DG.Tweening.Ease.InBack));
                                            }
                                        } finally {
                                            if (Bridge.is($t, System.IDisposable)) {
                                                $t.System$IDisposable$Dispose();
                                        ...
                                        $enumerator.current = DG.Tweening.TweenExtensions.WaitForCompletion(vanish);
                                        $step = 1;
                                        return true;
                                }
                                case 1: {
                                    $t1 = Bridge.getEnumerator(disks);
                                        try {
                                            while ($t1.moveNext()) {
                                                disk1 = $t1.Current;
                                                if (UnityEngine.MonoBehaviour.op_Inequality(disk1, null)) {
                                                    UnityEngine.MonoBehaviour.Destroy(disk1.gameObject);
                                                }
                                            }
                                        } finally {
                                            if (Bridge.is($t1, System.IDisposable)) {
...
if ( TRACE ) { TRACE( "TutorialController#WorldToCanvas", this ); }
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","UnityEngine","System.Collections.Generic","System.Collections","UnityEngine.UI","DG.Tweening","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening.Plugins.Core.PathCore","System.Globalization","DG.Tweening.Plugins.Options"];

    /*BoardController start.*/
    $m("BoardController", function () { return {"att":1048833,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"BuildNeighborCache","t":8,"sn":"BuildNeighborCache","rt":$n[0].Void},{"a":2,"n":"GetFirstEmptyCell","t":8,"sn":"GetFirstEmptyCell","rt":HexCell},{"a":1,"n":"GetGridNeighborDistance","t":8,"pi":[{"n":"gridPosition","pt":$n[1].Vector3Int,"ps":0}],"sn":"GetGridNeighborDistance","rt":$n[0].Single,"p":[$n[1].Vector3Int],"box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"GetLowestEmptyCell","t":8,"sn":"GetLowestEmptyCell","rt":HexCell},{"a":2,"n":"GetNeighbors","t":8,"pi":[{"n":"cell","pt":HexCell,"ps":0}],"sn":"GetNeighbors","rt":$n[2].List$1(HexCell),"p":[HexCell]},{"a":2,"n":"GetTutorialCell","t":8,"sn":"GetTutorialCell","rt":HexCell},{"a":2,"n":"Initialize","t":8,"sn":"Initialize","rt":$n[0].Void},{"a":1,"n":"SpawnInitialStack","t":8,"pi":[{"n":"cell","pt":HexCell,"ps":0}],"sn":"SpawnInitialStack","rt":$n[0].Void,"p":[HexCell]},{"a":2,"n":"TryGetDropCell","t":8,"pi":[{"n":"worldPosition","pt":$n[1].Vector3,"ps":0},{"n":"stack","pt":HexStack,"ps":1},{"n":"cell","out":true,"pt":HexCell,"ps":2}],"sn":"TryGetDropCell","rt":$n[0].Boolean,"p":[$n[1].Vector3,HexStack,HexCell],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"Cells","t":16,"rt":$n[2].IReadOnlyList$1(HexCell),"g":{"a":2,"n":"get_Cells","t":8,"rt":$n[2].IReadOnlyList$1(HexCell),"fg":"Cells"},"fn":"Cells"},{"a":1,"n":"CandidateNeighborOffsets","is":true,"t":4,"rt":System.Array.type(UnityEngine.Vector3Int),"sn":"CandidateNeighborOffsets","ro":true},{"a":1,"n":"NEIGHBOR_DISTANCE_TOLERANCE","is":true,"t":4,"rt":$n[0].Single,"sn":"NEIGHBOR_DISTANCE_TOLERANCE","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_cellByGridPosition","t":4,"rt":$n[2].Dictionary$2(UnityEngine.Vector3Int,HexCell),"sn":"_cellByGridPosition","ro":true},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_cells","t":4,"rt":$n[2].List$1(HexCell),"sn":"_cells"},{"at":[new UnityEngine.HeaderAttribute("Parameters"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_colorMaterials","t":4,"rt":$n[2].List$1(UnityEngine.Material),"sn":"_colorMaterials"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_diskPrefab","t":4,"rt":$n[1].Transform,"sn":"_diskPrefab"},{"at":[new UnityEngine.HeaderAttribute("Components"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_grid","t":4,"rt":( pc.stubProxy.generateConstructorFor( 'UnityEngine.Grid' ) ),"sn":"_grid"},{"a":1,"n":"_neighborsByCell","t":4,"rt":$n[2].Dictionary$2(HexCell,System.Collections.Generic.List$1(HexCell)),"sn":"_neighborsByCell","ro":true},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_snapRadius","t":4,"rt":$n[0].Single,"sn":"_snapRadius","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.HeaderAttribute("Prefabs"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_stackPrefab","t":4,"rt":HexStack,"sn":"_stackPrefab"}]}; }, $n);
    /*BoardController end.*/

    /*DragController start.*/
    $m("DragController", function () { return {"att":1048833,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"EndDrag","t":8,"sn":"EndDrag","rt":$n[0].Void},{"a":1,"n":"GetWorldPoint","t":8,"pi":[{"n":"screenPosition","pt":$n[1].Vector3,"ps":0}],"sn":"GetWorldPoint","rt":$n[1].Vector3,"p":[$n[1].Vector3]},{"a":2,"n":"Initialize","t":8,"pi":[{"n":"controller","pt":GameController,"ps":0},{"n":"cameraReference","pt":$n[1].Camera,"ps":1},{"n":"boardReference","pt":BoardController,"ps":2}],"sn":"Initialize","rt":$n[0].Void,"p":[GameController,$n[1].Camera,BoardController]},{"a":1,"n":"TryBeginDrag","t":8,"pi":[{"n":"screenPosition","pt":$n[1].Vector3,"ps":0}],"sn":"TryBeginDrag","rt":$n[0].Void,"p":[$n[1].Vector3]},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"UpdateDrag","t":8,"pi":[{"n":"screenPosition","pt":$n[1].Vector3,"ps":0}],"sn":"UpdateDrag","rt":$n[0].Void,"p":[$n[1].Vector3]},{"a":1,"n":"_board","t":4,"rt":BoardController,"sn":"_board"},{"a":1,"n":"_dragOffset","t":4,"rt":$n[1].Vector3,"sn":"_dragOffset"},{"a":1,"n":"_dragPlane","t":4,"rt":$n[1].Plane,"sn":"_dragPlane"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_draggableMask","t":4,"rt":$n[1].LayerMask,"sn":"_draggableMask"},{"a":1,"n":"_draggedStack","t":4,"rt":HexStack,"sn":"_draggedStack"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_followLerp","t":4,"rt":$n[0].Single,"sn":"_followLerp","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_gameCamera","t":4,"rt":$n[1].Camera,"sn":"_gameCamera"},{"a":1,"n":"_gameController","t":4,"rt":GameController,"sn":"_gameController"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_liftHeight","t":4,"rt":$n[0].Single,"sn":"_liftHeight","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_pointerDown","t":4,"rt":$n[0].Boolean,"sn":"_pointerDown","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}}]}; }, $n);
    /*DragController end.*/

    /*GameController start.*/
    $m("GameController", function () { return {"att":1048833,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"Configure","t":8,"pi":[{"n":"cameraReference","pt":$n[1].Camera,"ps":0},{"n":"boardReference","pt":BoardController,"ps":1},{"n":"dragReference","pt":DragController,"ps":2},{"n":"resolverReference","pt":ReactionResolver,"ps":3},{"n":"tutorialReference","pt":TutorialController,"ps":4},{"n":"packshotReference","pt":PackshotController,"ps":5}],"sn":"Configure","rt":$n[0].Void,"p":[$n[1].Camera,BoardController,DragController,ReactionResolver,TutorialController,PackshotController]},{"a":1,"n":"EnterState","t":8,"pi":[{"n":"nextState","pt":GameState,"ps":0}],"sn":"EnterState","rt":$n[0].Void,"p":[GameState]},{"a":1,"n":"FindSceneObjectIncludingInactive","is":true,"t":8,"tpc":1,"tprm":["T"],"sn":"FindSceneObjectIncludingInactive","rt":System.Object},{"a":1,"n":"FindSceneObjectsIncludingInactive","is":true,"t":8,"tpc":1,"tprm":["T"],"sn":"FindSceneObjectsIncludingInactive","rt":System.Array.type(System.Object)},{"a":1,"n":"HasRemainingOfferStacks","t":8,"sn":"HasRemainingOfferStacks","rt":$n[0].Boolean,"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"HasRequiredReferences","t":8,"sn":"HasRequiredReferences","rt":$n[0].Boolean,"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"InitializeStacks","t":8,"sn":"InitializeStacks","rt":$n[0].Void},{"a":2,"n":"NotifyDragCanceled","t":8,"sn":"NotifyDragCanceled","rt":$n[0].Void},{"a":2,"n":"NotifyStackGrabbed","t":8,"sn":"NotifyStackGrabbed","rt":$n[0].Void},{"a":2,"n":"NotifyStackPlaced","t":8,"pi":[{"n":"stack","pt":HexStack,"ps":0},{"n":"cell","pt":HexCell,"ps":1}],"sn":"NotifyStackPlaced","rt":$n[0].Void,"p":[HexStack,HexCell]},{"a":1,"n":"ResolveSceneReferences","t":8,"sn":"ResolveSceneReferences","rt":$n[0].Void},{"a":1,"n":"RunTurn","t":8,"pi":[{"n":"placedStack","pt":HexStack,"ps":0},{"n":"placedCell","pt":HexCell,"ps":1}],"sn":"RunTurn","rt":$n[3].IEnumerator,"p":[HexStack,HexCell]},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"IsInputEnabled","t":16,"rt":$n[0].Boolean,"g":{"a":2,"n":"get_IsInputEnabled","t":8,"rt":$n[0].Boolean,"fg":"IsInputEnabled","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},"fn":"IsInputEnabled"},{"a":2,"n":"State","t":16,"rt":GameState,"g":{"a":2,"n":"get_State","t":8,"rt":GameState,"fg":"State","box":function ($v) { return Bridge.box($v, GameState, System.Enum.toStringFn(GameState));}},"s":{"a":1,"n":"set_State","t":8,"p":[GameState],"rt":$n[0].Void,"fs":"State"},"fn":"State"},{"a":1,"n":"__Property__Initializer__State","t":4,"rt":GameState,"sn":"__Property__Initializer__State","box":function ($v) { return Bridge.box($v, GameState, System.Enum.toStringFn(GameState));}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_board","t":4,"rt":BoardController,"sn":"_board"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_dragController","t":4,"rt":DragController,"sn":"_dragController"},{"at":[new UnityEngine.HeaderAttribute("Scene"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_gameCamera","t":4,"rt":$n[1].Camera,"sn":"_gameCamera"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_packshot","t":4,"rt":PackshotController,"sn":"_packshot"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_reactionResolver","t":4,"rt":ReactionResolver,"sn":"_reactionResolver"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_tutorial","t":4,"rt":TutorialController,"sn":"_tutorial"},{"a":1,"n":"_tutorialCompleted","t":4,"rt":$n[0].Boolean,"sn":"_tutorialCompleted","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"backing":true,"n":"<State>k__BackingField","t":4,"rt":GameState,"sn":"State","box":function ($v) { return Bridge.box($v, GameState, System.Enum.toStringFn(GameState));}}]}; }, $n);
    /*GameController end.*/
    ...
    /*HexCell start.*/
    $m("HexCell", function () { return {"att":1048833,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"ClearStack","t":8,"pi":[{"n":"stack","pt":HexStack,"ps":0}],"sn":"ClearStack","rt":$n[0].Void,"p":[HexStack]},{"a":2,"n":"Configure","t":8,"pi":[{"n":"gridPosition","pt":$n[1].Vector3Int,"ps":0}],"sn":"Configure","rt":$n[0].Void,"p":[$n[1].Vector3Int]},{"a":2,"n":"Initialize","t":8,"sn":"Initialize","rt":$n[0].Void},{"a":2,"n":"SetHighlight","t":8,"pi":[{"n":"enabled","pt":$n[0].Boolean,"ps":0}],"sn":"SetHighlight","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"SetInitialStackColors","t":8,"pi":[{"n":"colors","pt":$n[2].List$1(HexColorId),"ps":0}],"sn":"SetInitialStackColors","rt":$n[0].Void,"p":[$n[2].List$1(HexColorId)]},{"a":2,"n":"SetRingRenderer","t":8,"pi":[{"n":"renderer","pt":$n[1].Renderer,"ps":0}],"sn":"SetRingRenderer","rt":$n[0].Void,"p":[$n[1].Renderer]},{"a":2,"n":"SetStack","t":8,"pi":[{"n":"stack","pt":HexStack,"ps":0}],"sn":"SetStack","rt":$n[0].Void,"p":[HexStack]},{"a":2,"n":"CurrentStack","t":16,"rt":HexStack,"g":{"a":2,"n":"get_CurrentStack","t":8,"rt":HexStack,"fg":"CurrentStack"},"fn":"CurrentStack"},{"a":2,"n":"GridPosition","t":16,"rt":$n[1].Vector3Int,"g":{"a":2,"n":"get_GridPosition","t":8,"rt":$n[1].Vector3Int,"fg":"GridPosition"},"fn":"GridPosition"},{"a":2,"n":"InitialStackColors","t":16,"rt":$n[2].IReadOnlyList$1(HexColorId),"g":{"a":2,"n":"get_InitialStackColors","t":8,"rt":$n[2].IReadOnlyList$1(HexColorId),"fg":"InitialStackColors"},"fn":"InitialStackColors"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_currentStack","t":4,"rt":HexStack,"sn":"_currentStack"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_gridPosition","t":4,"rt":$n[1].Vector3Int,"sn":"_gridPosition"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_initialStackColors","t":4,"rt":$n[2].List$1(HexColorId),"sn":"_initialStackColors"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_ringRenderer","t":4,"rt":$n[1].Renderer,"sn":"_ringRenderer"}]}; }, $n);
    /*HexCell end.*/
    ...
    /*HexDisk start.*/
    $m("HexDisk", function () { return {"att":1048833,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"CacheRenderers","t":8,"sn":"CacheRenderers","rt":$n[0].Void},{"a":2,"n":"Initialize","t":8,"pi":[{"n":"color","pt":HexColorId,"ps":0},{"n":"material","pt":$n[1].Material,"ps":1}],"sn":"Initialize","rt":$n[0].Void,"p":[HexColorId,$n[1].Material]},{"a":2,"n":"SetAlpha","t":8,"pi":[{"n":"alpha","pt":$n[0].Single,"ps":0}],"sn":"SetAlpha","rt":$n[0].Void,"p":[$n[0].Single]},{"a":2,"n":"Color","t":16,"rt":HexColorId,"g":{"a":2,"n":"get_Color","t":8,"rt":HexColorId,"fg":"Color","box":function ($v) { return Bridge.box($v, HexColorId, System.Enum.toStringFn(HexColorId));}},"fn":"Color"},{"a":2,"n":"Renderers","t":16,"rt":System.Array.type(UnityEngine.Renderer),"g":{"a":2,"n":"get_Renderers","t":8,"rt":System.Array.type(UnityEngine.Renderer),"fg":"Renderers"},"fn":"Renderers"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_color","t":4,"rt":HexColorId,"sn":"_color","box":function ($v) { return Bridge.box($v, HexColorId, System.Enum.toStringFn(HexColorId));}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_renderers","t":4,"rt":System.Array.type(UnityEngine.Renderer),"sn":"_renderers"}]}; }, $n);
    /*HexDisk end.*/

    /*HexStack start.*/
    $m("HexStack", function () { return {"att":1048833,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"AssignCell","t":8,"pi":[{"n":"cell","pt":HexCell,"ps":0}],"sn":"AssignCell","rt":$n[0].Void,"p":[HexCell]},{"a":2,"n":"BuildVisuals","t":8,"sn":"BuildVisuals","rt":$n[0].Void},{"a":2,"n":"Configure","t":8,"pi":[{"n":"prefab","pt":$n[1].Transform,"ps":0},{"n":"materials","pt":$n[2].List$1(UnityEngine.Material),"ps":1},{"n":"colors","pt":$n[2].List$1(HexColorId),"ps":2},{"n":"offer","pt":$n[0].Boolean,"ps":3},{"n":"solution","pt":$n[0].Boolean,"ps":4}],"sn":"Configure","rt":$n[0].Void,"p":[$n[1].Transform,$n[2].List$1(UnityEngine.Material),$n[2].List$1(HexColorId),$n[0].Boolean,$n[0].Boolean]},{"a":2,"n":"CountTopColor","t":8,"pi":[{"n":"color","pt":HexColorId,"ps":0}],"sn":"CountTopColor","rt":$n[0].Int32,"p":[HexColorId],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"CreateDisk","t":8,"pi":[{"n":"color","pt":HexColorId,"ps":0},{"n":"index","pt":$n[0].Int32,"ps":1}],"sn":"CreateDisk","rt":$n[0].Void,"p":[HexColorId,$n[0].Int32]},{"a":2,"n":"DetachFromCell","t":8,"sn":"DetachFromCell","rt":$n[0].Void},{"a":1,"n":"GetDiskLocalPosition","t":8,"pi":[{"n":"index","pt":$n[0].Int32,"ps":0}],"sn":"GetDiskLocalPosition","rt":$n[1].Vector3,"p":[$n[0].Int32]},{"a":2,"n":"GetDiskWorldPositionAtIndex","t":8,"pi":[{"n":"index","pt":$n[0].Int32,"ps":0}],"sn":"GetDiskWorldPositionAtIndex","rt":$n[1].Vector3,"p":[$n[0].Int32]},{"a":2,"n":"GetNextDiskWorldPosition","t":8,"sn":"GetNextDiskWorldPosition","rt":$n[1].Vector3},{"a":2,"n":"InitializeRuntime","t":8,"sn":"InitializeRuntime","rt":$n[0].Void},{"a":2,"n":"IsSingleColorStack","t":8,"pi":[{"n":"expectedCount","pt":$n[0].Int32,"ps":0}],"sn":"IsSingleColorStack","rt":$n[0].Boolean,"p":[$n[0].Int32],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"MarkAsPlacedOnBoard","t":8,"sn":"MarkAsPlacedOnBoard","rt":$n[0].Void},{"a":2,"n":"PopTopDisk","t":8,"sn":"PopTopDisk","rt":HexDisk},{"a":2,"n":"PushDisk","t":8,"pi":[{"n":"disk","pt":HexDisk,"ps":0}],"sn":"PushDisk","rt":$n[0].Void,"p":[HexDisk]},{"a":2,"n":"Reflow","t":8,"sn":"Reflow","rt":$n[0].Void},{"a":2,"n":"RemoveTopDisks","t":8,"pi":[{"n":"amount","pt":$n[0].Int32,"ps":0}],"sn":"RemoveTopDisks","rt":$n[2].List$1(HexDisk),"p":[$n[0].Int32]},{"a":2,"n":"StoreHome","t":8,"sn":"StoreHome","rt":$n[0].Void},{"a":2,"n":"Count","t":16,"rt":$n[0].Int32,"g":{"a":2,"n":"get_Count","t":8,"rt":$n[0].Int32,"fg":"Count","box":function ($v) { return Bridge.box($v, System.Int32);}},"fn":"Count"},{"a":2,"n":"CurrentCell","t":16,"rt":HexCell,"g":{"a":2,"n":"get_CurrentCell","t":8,"rt":HexCell,"fg":"CurrentCell"},"fn":"CurrentCell"},{"a":2,"n":"HomeParent","t":16,"rt":$n[1].Transform,"g":{"a":2,"n":"get_HomeParent","t":8,"rt":$n[1].Transform,"fg":"HomeParent"},"fn":"HomeParent"},{"a":2,"n":"HomePosition","t":16,"rt":$n[1].Vector3,"g":{"a":2,"n":"get_HomePosition","t":8,"rt":$n[1].Vector3,"fg":"HomePosition"},"fn":"HomePosition"},{"a":2,"n":"IsEmpty","t":16,"rt":$n[0].Boolean,"g":{"a":2,"n":"get_IsEmpty","t":8,"rt":$n[0].Boolean,"fg":"IsEmpty","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},"fn":"IsEmpty"},{"a":2,"n":"IsOfferStack","t":16,"rt":$n[0].Boolean,"g":{"a":2,"n":"get_IsOfferStack","t":8,"rt":$n[0].Boolean,"fg":"IsOfferStack","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},"fn":"IsOfferStack"},{"a":2,"n":"IsSolutionStack","t":16,"rt":$n[0].Boolean,"g":{"a":2,"n":"get_IsSolutionStack","t":8,"rt":$n[0].Boolean,"fg":"IsSolutionStack","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},"fn":"IsSolutionStack"},{"a":2,"n":"TopColor","t":16,"rt":HexColorId,"g":{"a":2,"n":"get_TopColor","t":8,"rt":HexColorId,"fg":"TopColor","box":function ($v) { return Bridge.box($v, HexColorId, System.Enum.toStringFn(HexColorId));}},"fn":"TopColor"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_colorMaterials","t":4,"rt":$n[2].List$1(UnityEngine.Material),"sn":"_colorMaterials"},{"a":1,"n":"_currentCell","t":4,"rt":HexCell,"sn":"_currentCell"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_diskHeight","t":4,"rt":$n[0].Single,"sn":"_diskHeight","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_diskPrefab","t":4,"rt":$n[1].Transform,"sn":"_diskPrefab"},{"a":1,"n":"_disks","t":4,"rt":$n[2].List$1(HexDisk),"sn":"_disks","ro":true},{"a":1,"n":"_homeParent","t":4,"rt":$n[1].Transform,"sn":"_homeParent"},{"a":1,"n":"_homePosition","t":4,"rt":$n[1].Vector3,"sn":"_homePosition"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_initialColors","t":4,"rt":$n[2].List$1(HexColorId),"sn":"_initialColors"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_isOfferStack","t":4,"rt":$n[0].Boolean,"sn":"_isOfferStack","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_isSolutionStack","t":4,"rt":$n[0].Boolean,"sn":"_isSolutionStack","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}}]}; }, $n);
    /*HexStack end.*/

    /*PackshotController start.*/
    $m("PackshotController", function () { return {"att":1048833,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"Configure","t":8,"pi":[{"n":"groupReference","pt":$n[1].CanvasGroup,"ps":0},{"n":"buttonReference","pt":$n[4].Button,"ps":1}],"sn":"Configure","rt":$n[0].Void,"p":[$n[1].CanvasGroup,$n[4].Button]},{"a":1,"n":"FindType","is":true,"t":8,"pi":[{"n":"fullName","pt":$n[0].String,"ps":0}],"sn":"FindType","rt":$n[0].Type,"p":[$n[0].String]},{"a":1,"n":"GameEnded","t":8,"sn":"GameEnded","rt":$n[0].Void},{"a":1,"n":"GetDefaultValue","is":true,"t":8,"pi":[{"n":"type","pt":$n[0].Type,"ps":0}],"sn":"GetDefaultValue","rt":$n[0].Object,"p":[$n[0].Type]},{"a":2,"n":"HideInstant","t":8,"sn":"HideInstant","rt":$n[0].Void},{"a":1,"n":"InstallFullGame","t":8,"sn":"InstallFullGame","rt":$n[0].Void},{"a":1,"n":"InvokeLunaStatic","is":true,"t":8,"pi":[{"n":"typeName","pt":$n[0].String,"ps":0},{"n":"methodName","pt":$n[0].String,"ps":1}],"sn":"InvokeLunaStatic","rt":$n[0].Void,"p":[$n[0].String,$n[0].String]},{"a":2,"n":"Show","t":8,"sn":"Show","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_fadeDuration","t":4,"rt":$n[0].Single,"sn":"_fadeDuration","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_group","t":4,"rt":$n[1].CanvasGroup,"sn":"_group"},{"a":1,"n":"_installRequested","t":4,"rt":$n[0].Boolean,"sn":"_installRequested","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_playButtonView","t":4,"rt":PlayButtonView,"sn":"_playButtonView"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_playNowButton","t":4,"rt":$n[4].Button,"sn":"_playNowButton"},{"a":1,"n":"_shown","t":4,"rt":$n[0].Boolean,"sn":"_shown","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}}]}; }, $n);
    /*PackshotController end.*/

    /*PlayButtonView start.*/
    $m("PlayButtonView", function () { return {"att":1048833,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"OnDisable","t":8,"sn":"OnDisable","rt":$n[0].Void},{"a":2,"n":"Play","t":8,"sn":"Play","rt":$n[0].Void},{"a":2,"n":"Stop","t":8,"sn":"Stop","rt":$n[0].Void},{"a":1,"n":"_pulse","t":4,"rt":$n[5].Sequence,"sn":"_pulse"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_pulseDuration","t":4,"rt":$n[0].Single,"sn":"_pulseDuration","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_pulseScale","t":4,"rt":$n[0].Single,"sn":"_pulseScale","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_target","t":4,"rt":$n[1].RectTransform,"sn":"_target"}]}; }, $n);
    /*PlayButtonView end.*/

    /*ReactionResolver start.*/
    $m("ReactionResolver", function () { return {"att":1048833,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"AnimateRollingDisk","t":8,"pi":[{"n":"disk","pt":HexDisk,"ps":0},{"n":"receiver","pt":HexStack,"ps":1},{"n":"target","pt":$n[1].Vector3,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3},{"n":"onComplete","pt":Function,"ps":4}],"sn":"AnimateRollingDisk","rt":$n[0].Void,"p":[HexDisk,HexStack,$n[1].Vector3,$n[0].Single,Function]},{"a":1,"n":"CanMerge","t":8,"pi":[{"n":"receiverCell","pt":HexCell,"ps":0},{"n":"donorCell","pt":HexCell,"ps":1}],"sn":"CanMerge","rt":$n[0].Boolean,"p":[HexCell,HexCell],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"CleanFullStacks","t":8,"sn":"CleanFullStacks","rt":$n[3].IEnumerator},{"a":2,"n":"Configure","t":8,"pi":[{"n":"fxPrefab","pt":$n[1].GameObject,"ps":0},{"n":"maxSpeedMultiplier","pt":$n[0].Single,"ps":1}],"sn":"Configure","rt":$n[0].Void,"p":[$n[1].GameObject,$n[0].Single]},{"a":1,"n":"GetMergeDiskCount","t":8,"pi":[{"n":"receiver","pt":HexStack,"ps":0},{"n":"donor","pt":HexStack,"ps":1}],"sn":"GetMergeDiskCount","rt":$n[0].Int32,"p":[HexStack,HexStack],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"GetScaledDuration","t":8,"pi":[{"n":"baseDuration","pt":$n[0].Single,"ps":0}],"sn":"GetScaledDuration","rt":$n[0].Single,"p":[$n[0].Single],"box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"Initialize","t":8,"pi":[{"n":"boardReference","pt":BoardController,"ps":0}],"sn":"Initialize","rt":$n[0].Void,"p":[BoardController]},{"a":2,"n":"MergeFrom","t":8,"pi":[{"n":"placedCell","pt":HexCell,"ps":0}],"sn":"MergeFrom","rt":$n[3].IEnumerator,"p":[HexCell]},{"a":1,"n":"MergeStacks","t":8,"pi":[{"n":"receiverCell","pt":HexCell,"ps":0},{"n":"donorCell","pt":HexCell,"ps":1}],"sn":"MergeStacks","rt":$n[3].IEnumerator,"p":[HexCell,HexCell]},{"a":1,"n":"PushIfCheckable","t":8,"pi":[{"n":"cell","pt":HexCell,"ps":0}],"sn":"PushIfCheckable","rt":$n[0].Void,"p":[HexCell]},{"a":1,"n":"VanishStack","t":8,"pi":[{"n":"cell","pt":HexCell,"ps":0},{"n":"stack","pt":HexStack,"ps":1}],"sn":"VanishStack","rt":$n[3].IEnumerator,"p":[HexCell,HexStack]},{"a":2,"n":"LastResolveHadReaction","t":16,"rt":$n[0].Boolean,"g":{"a":2,"n":"get_LastResolveHadReaction","t":8,"rt":$n[0].Boolean,"fg":"LastResolveHadReaction","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},"s":{"a":1,"n":"set_LastResolveHadReaction","t":8,"p":[$n[0].Boolean],"rt":$n[0].Void,"fs":"LastResolveHadReaction"},"fn":"LastResolveHadReaction"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_baseFlyDuration","t":4,"rt":$n[0].Single,"sn":"_baseFlyDuration","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_baseVanishDuration","t":4,"rt":$n[0].Single,"sn":"_baseVanishDuration","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_board","t":4,"rt":BoardController,"sn":"_board"},{"a":1,"n":"_cellsToCheck","t":4,"rt":$n[2].Stack$1(HexCell),"sn":"_cellsToCheck","ro":true},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_diskLaunchInterval","t":4,"rt":$n[0].Single,"sn":"_diskLaunchInterval","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_edgePivotOffset","t":4,"rt":$n[0].Single,"sn":"_edgePivotOffset","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_maxReactionSpeedMultiplier","t":4,"rt":$n[0].Single,"sn":"_maxReactionSpeedMultiplier","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_reactionStep","t":4,"rt":$n[0].Int32,"sn":"_reactionStep","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_rollDegrees","t":4,"rt":$n[0].Single,"sn":"_rollDegrees","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_speedIncrease","t":4,"rt":$n[0].Single,"sn":"_speedIncrease","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_vanishFxPrefab","t":4,"rt":$n[1].GameObject,"sn":"_vanishFxPrefab"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_vanishStackSize","t":4,"rt":$n[0].Int32,"sn":"_vanishStackSize","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"backing":true,"n":"<LastResolveHadReaction>k__BackingField","t":4,"rt":$n[0].Boolean,"sn":"LastResolveHadReaction","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}}]}; }, $n);
    /*ReactionResolver end.*/

    /*TutorialController start.*/
    $m("TutorialController", function () { return {"att":1048833,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Configure","t":8,"pi":[{"n":"handReference","pt":$n[1].RectTransform,"ps":0},{"n":"canvasReference","pt":$n[1].Canvas,"ps":1},{"n":"cameraReference","pt":$n[1].Camera,"ps":2},{"n":"sourceReference","pt":$n[1].Transform,"ps":3}],"sn":"Configure","rt":$n[0].Void,"p":[$n[1].RectTransform,$n[1].Canvas,$n[1].Camera,$n[1].Transform]},{"a":2,"n":"Hide","t":8,"sn":"Hide","rt":$n[0].Void},{"a":2,"n":"Initialize","t":8,"pi":[{"n":"boardReference","pt":BoardController,"ps":0}],"sn":"Initialize","rt":$n[0].Void,"p":[BoardController]},{"a":2,"n":"Play","t":8,"sn":"Play","rt":$n[0].Void},{"a":1,"n":"ReplayAfterDelay","t":8,"sn":"ReplayAfterDelay","rt":$n[3].IEnumerator},{"a":2,"n":"ScheduleReplay","t":8,"sn":"ScheduleReplay","rt":$n[0].Void},{"a":1,"n":"WorldToCanvas","t":8,"pi":[{"n":"world","pt":$n[1].Vector3,"ps":0}],"sn":"WorldToCanvas","rt":$n[1].Vector2,"p":[$n[1].Vector3]},{"a":1,"n":"_board","t":4,"rt":BoardController,"sn":"_board"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_canvas","t":4,"rt":$n[1].Canvas,"sn":"_canvas"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_gameCamera","t":4,"rt":$n[1].Camera,"sn":"_gameCamera"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_hand","t":4,"rt":$n[1].RectTransform,"sn":"_hand"},{"a":1,"n":"_loop","t":4,"rt":$n[5].Sequence,"sn":"_loop"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_pressOffset","t":4,"rt":$n[1].Vector2,"sn":"_pressOffset"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_releaseOffset","t":4,"rt":$n[1].Vector2,"sn":"_releaseOffset"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_replayDelay","t":4,"rt":$n[0].Single,"sn":"_replayDelay","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"_replayRoutine","t":4,"rt":$n[1].Coroutine,"sn":"_replayRoutine"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"_sourceStack","t":4,"rt":$n[1].Transform,"sn":"_sourceStack"}]}; }, $n);
    /*TutorialController end.*/
